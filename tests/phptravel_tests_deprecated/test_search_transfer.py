...
class TestTransferSearch:
    ...
    def test_search_transfer_data_driven(self, data):
        ...
        search_transfer.set_depart_date(data.depart_year, data.depart_month, data.depart_day)
        search_transfer.set_depart_time(data.depart_time)
        search_transfer.set_return_date(data.return_year, data.return_month, data.return_day)
